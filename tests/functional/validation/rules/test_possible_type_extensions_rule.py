        ...
        (
            ...
            [
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
                    locations=[
                        Location(line=2, column=27, line_end=2, column_end=34)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
                    locations=[
                        Location(line=3, column=25, line_end=3, column_end=32)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
                    locations=[
                        Location(line=4, column=30, line_end=4, column_end=37)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
                    locations=[
                        Location(line=5, column=26, line_end=5, column_end=33)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
                    locations=[
                        Location(line=6, column=25, line_end=6, column_end=32)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend type < Unknown > because it is not defined.Did you mean Known?",
        ...
        (
            ...
            [
                TartifletteError(
                    message="Cannot extend non-scalar type < FooScalar >.",
                    locations=[
                        Location(line=2, column=13, line_end=2, column_end=41)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend non-object type < FooObject >.",
                    locations=[
                        Location(line=3, column=13, line_end=3, column_end=46)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend non-interface type < FooInterface >.",
                    locations=[
                        Location(line=4, column=13, line_end=4, column_end=45)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend non-union type < FooUnion >.",
                    locations=[
                        Location(line=5, column=13, line_end=5, column_end=40)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend non-enum type < FooEnum >.",
                    locations=[
                        Location(line=6, column=13, line_end=6, column_end=40)
                    ],
                ),
                TartifletteError(
                    message="Cannot extend non-input object type < FooInputObject >.",
                    locations=[
                        Location(line=7, column=13, line_end=7, column_end=48)
                    ],
                ),
            ],
        ),
...
async def test_possible_type_extensions(old_sdl, new_sdl, expected):
    old_schema = None
    if old_sdl:
        old_schema = schema_from_sdl(old_sdl, "test_possible_type_extensions")
